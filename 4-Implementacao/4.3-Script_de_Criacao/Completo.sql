...
ALTER TABLE Diario ADD CONSTRAINT FK_Diario_2 FOREIGN KEY (idContasPagar) REFERENCES ContasPagar (idContasPagar);
ALTER TABLE Diario ADD CONSTRAINT FK_Diario_3 FOREIGN KEY (idContasReceber) REFERENCES ContasReceber (idContasReceber);
