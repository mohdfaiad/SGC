...
ALTER TABLE Diario ADD CONSTRAINT FK_Diario_1 FOREIGN KEY (idContasPagar) REFERENCES ContasPagar (idContasPagar);
ALTER TABLE Diario ADD CONSTRAINT FK_Diario_2 FOREIGN KEY (idContasReceber) REFERENCES ContasReceber (idContasReceber);
ALTER TABLE Diario ADD CONSTRAINT FK_Diario_3 FOREIGN KEY (idPlanoContas) REFERENCES PlanoContas (idPlanoContas);
...
ALTER TABLE ContaCorrente ADD CONSTRAINT FK_ContaCorrente_1 FOREIGN KEY (idDiario) REFERENCES Diario (idDiario);
