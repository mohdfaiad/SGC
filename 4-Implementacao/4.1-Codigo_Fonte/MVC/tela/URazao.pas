...
begin
        ...
        begin
          ...
          lcto := LctoController.Consultar(' ( ( idcontadebito = '+ IntToStr(Plano[T].idPlanoContas) + ' or idcontacredito = ' + IntToStr(Plano[T].idPlanoContas) + ')' +
...
begin
    ...
    with rdprint1 do begin
        ...
        Impc(Lin,((TamanhoQteColunas+colunainicial) div 2),'Razão',[]);
        ...
        Impf(Lin,38+colunainicial,'Histórico',[]);
